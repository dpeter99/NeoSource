...
public class Matrix4x4 {
    ...
    private static final Matrix4x4 _identity = new Matrix4x4
            (
            1f, 0f, 0f, 0f,
                    0f, 1f, 0f, 0f,
                    0f, 0f, 1f, 0f,
    ...
    */
    ...
    {
        final float epsilon = 1e-4f;
        final float minAngle = 1.0f - (0.1f * ((float) Math.PI / 180.0f)); // 0.1 degrees
    ...
    public static Matrix4x4 CreatePerspectiveFieldOfView(float fieldOfView, float aspectRatio, float nearPlaneDistance, float farPlaneDistance)
    {
        ...
        Float negFarRange = Float.isInfinite(farPlaneDistance) ? -1.0f : farPlaneDistance / (nearPlaneDistance - farPlaneDistance);
    ...
    public static Matrix4x4 CreatePerspectiveOffCenter(float left, float right, float bottom, float top, float nearPlaneDistance, float farPlaneDistance)
    {
        ...
        //TODO: Float.IsPositiveInfinity(farPlaneDistance)
        Float negFarRange = Float.isInfinite(farPlaneDistance) ? -1.0f : farPlaneDistance / (nearPlaneDistance - farPlaneDistance);
        result.M33 = negFarRange;
        result.M34 = -1.0f;
