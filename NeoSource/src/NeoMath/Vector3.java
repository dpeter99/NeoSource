...
public class Vector3
{
    ...
    /// </summary>
    public static Vector3 getOne() {return new Vector3(1.0f, 1.0f, 1.0f); }
    /// <summary>
    ...
    //TODO: add this constructor with Vector2
    ...
    */
    ...
    //TODO: fix the sqrt and decide on impl.
    public float Length()
    {
    ...
    public static float Distance(Vector3 value1, Vector3 value2)
    {
        if (Vector.IsHardwareAccelerated)
        {
            Vector3 difference = Subtract(value1, value2);
    ...
    public static Vector3 Reflect(Vector3 vector, Vector3 normal)
    {
        if (Vector.IsHardwareAccelerated)
        {
            ...
            Vector3 temp = Multiply( Multiply(normal, dot), 2f);
            return Subtract(vector, temp);
        }
        else
        {
    ...
    public static Vector3 Lerp(Vector3 value1, Vector3 value2, float amount)
    {
        if (Vector.IsHardwareAccelerated)
        {
            Vector3 firstInfluence = Multiply(value1 , (1f - amount));
            Vector3 secondInfluence = Multiply(value2 , amount);
            return Add(firstInfluence,secondInfluence);
        }
        else
        {
            return new Vector3(
    ...
    {
        return Vector3.Multiply(left, new Vector3(right));
    }
    ...
    {
        return Vector3.Multiply(new Vector3(left), right);
    }
    ...
    {
        return Vector3.Subtract(getZero(), value);
    }
